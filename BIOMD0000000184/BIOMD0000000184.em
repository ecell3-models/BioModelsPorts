...
# from file: ../BIOMD0000000184/BIOMD0000000184.eml, date: Mon Dec 16 22:55:46 2013
#
...
System System( / )
{
	...
	Process ExpressionFluxProcess( R1 )
	{
		...
		VariableReferenceList	[ P0 Variable:/compartment:X 1 ] [ compartment Variable:/compartment:SIZE 0 ] [ Param0 Variable:/SBMLParameter:vin 0 ];
	}
	...
	Process ExpressionFluxProcess( R2 )
	{
		...
		VariableReferenceList	[ S0 Variable:/compartment:X -1 ] [ compartment Variable:/compartment:SIZE 0 ] [ Param0 Variable:/SBMLParameter:kout 0 ];
	}
	...
	Process ExpressionFluxProcess( R3 )
	{
		...
		VariableReferenceList	[ S0 Variable:/ER:Y -1 ] [ P0 Variable:/compartment:X 1 ] [ C0 Variable:/compartment:Z 0 ] [ ER Variable:/ER:SIZE 0 ] [ Param0 Variable:/SBMLParameter:vM3 0 ] [ Param1 Variable:/SBMLParameter:k_CaA 0 ] [ Param2 Variable:/SBMLParameter:n 0 ] [ Param3 Variable:/SBMLParameter:k_CaI 0 ] [ Param4 Variable:/SBMLParameter:m 0 ] [ Param5 Variable:/SBMLParameter:kip3 0 ];
	}
	...
	Process ExpressionFluxProcess( R4 )
	{
		...
		VariableReferenceList	[ S0 Variable:/compartment:X -1 ] [ P0 Variable:/ER:Y 1 ] [ compartment Variable:/compartment:SIZE 0 ] [ Param0 Variable:/SBMLParameter:vM2 0 ] [ Param1 Variable:/SBMLParameter:k2 0 ];
	}
	...
	Process ExpressionFluxProcess( R5 )
	{
		...
		VariableReferenceList	[ S0 Variable:/ER:Y -1 ] [ P0 Variable:/compartment:X 1 ] [ ER Variable:/ER:SIZE 0 ] [ Param0 Variable:/SBMLParameter:kf 0 ];
	}
	...
	Process ExpressionFluxProcess( R6 )
	{
		...
		VariableReferenceList	[ P0 Variable:/compartment:Z 1 ] [ C0 Variable:/compartment:X 0 ] [ compartment Variable:/compartment:SIZE 0 ] [ Param0 Variable:/SBMLParameter:vp 0 ] [ Param1 Variable:/SBMLParameter:kp 0 ];
	}
	...
	Process ExpressionFluxProcess( R7 )
	{
		...
		Expression	"compartment.Value * Param0.Value * (S0.Value / compartment.Value)";
		VariableReferenceList	[ S0 Variable:/compartment:Z -1 ] [ compartment Variable:/compartment:SIZE 0 ] [ Param0 Variable:/SBMLParameter:kdeg 0 ];
	}
