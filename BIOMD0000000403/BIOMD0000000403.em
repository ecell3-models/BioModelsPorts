...
# from file: BIOMD0000000403.eml, date: Sun Mar  2 21:13:25 2014
#
...
System System( /SBMLRule )
{
	...
	Process ExpressionFluxProcess( Rate_B )
	{
		...
		Expression	"alpha2.NumberConc * pow(C.NumberConc, g12.NumberConc / (1 + r12.NumberConc * Tumour.NumberConc / LT.NumberConc)) * pow(B.NumberConc, g22.NumberConc - r22.NumberConc * Tumour.NumberConc / LT.NumberConc) - (beta2.NumberConc - V1.NumberConc) * B.NumberConc";
		VariableReferenceList
	...
	Process ExpressionFluxProcess( Rate_Tumour )
	{
		...
		Expression	"(gammaT.NumberConc - V2.NumberConc) * Tumour.NumberConc * log(LT.NumberConc / Tumour.NumberConc)";
		VariableReferenceList
			[ Tumour Variable:/Compartment:Tumour   1 ]
			[ gammaT Variable:/SBMLParameter:gammaT 0 ]
			[ V2     Variable:/SBMLParameter:V2     0 ]
			[ LT     Variable:/SBMLParameter:LT     0 ];
	}
	...
	Process ExpressionAssignmentProcess( Assignment_V1 )
	{
		...
		Expression	"piecewise(v1.NumberConc, geq(<t>, 600), 0)";
		VariableReferenceList
			[ V1 Variable:/SBMLParameter:V1 1 ]
			[ v1 Variable:/SBMLParameter:v1 0 ];
	}
	
	Process ExpressionAssignmentProcess( Assignment_V2 )
	{
		StepperID	Default;
		Name	"Assignment rule for 'V2'";
		Expression	"piecewise(v2.NumberConc, geq(<t>, 600), 0)";
		VariableReferenceList
			[ V2 Variable:/SBMLParameter:V2 1 ]
			[ v2 Variable:/SBMLParameter:v2 0 ];
	}
